...
INSERT INTO users (id, user_status, email, email_verified, password_hash, username) VALUES
            (1, 'admin', 'admin@lingvopal.com', true, '$2b$12$XbbY670KjWrbOgYJ/XipFO3ociSlj7V0nvor//yYwd5vGLw0wS3Zq', 'admin_user'),
            ...
            (4, 'user', 'test.user@example.com', false, '$2b$12$XbbY670KjWrbOgYJ/XipFO3ociSlj7V0nvor//yYwd5vGLw0wS3Zq', 'test_user')
            ON CONFLICT (id) DO NOTHING;
