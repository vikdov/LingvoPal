...
def downgrade() -> None:
    ...
    op.execute("DROP TYPE IF EXISTS session_status_type")
    op.execute("DROP TYPE IF EXISTS moderation_status")
    op.execute("DROP TYPE IF EXISTS moderation_target_type")
    op.execute("DROP TYPE IF EXISTS content_status")
    op.execute("DROP TYPE IF EXISTS part_of_speech_type")
    op.execute("DROP TYPE IF EXISTS retention_priority")
    op.execute("DROP TYPE IF EXISTS evaluation_mode")
    op.execute("DROP TYPE IF EXISTS learning_intensity")
